...
// this should probably be any small screen touch-device, i don't know the defines for all of them so i'll cover android and IOS as i imagine they're more common
	...
	_info.push_back(OptionInfo("fairPsionics", &fairPsionics, false, "STR_FAIRPSIONICS", "STR_BATTLESCAPE"));
	_info.push_back(OptionInfo("reducedFirstTurnReactions", &reducedFirstTurnReactions, false, "STR_REDUCEDFIRSTTURNREACTIONS", "STR_BATTLESCAPE"));
